...
<head>
  ...
  <link type="text/css" href="bootstrap-timepicker.min.css" />
        ...
        <input id="heading1" name="HiddenParam" type="hidden" />
        <input id="heading2" name="HiddenParam" type="hidden" />  
        <input id="heading3" name="HiddenParam" type="hidden" /> 
...
//            out.println("Result = "+result.toString());
    ...
    %>
      ...
      <div style=" width: 360px; margin: 7% auto; margin-top: 20px; margin-bottom: 20px;">
        ...
        <form action="" method="post" id ="goal">
          ...
          <div class="text-center">
            ...
            <!-- <button type="submit" class="btn btn-block btn-danger btn-flat"> Sign In</button> -->
            <!-- <a href="register.html" class="btn btn-block btn-primary btn-flat"> Create a new acount</a> -->
      ...
      <div id="graph-container" style=" width: 100%;
       text-align:center;">
      <!--<canvas id="results-graph" width="500" height="300"></canvas>-->
      ...
      if(startdate<=31&&enddate<=31){
        if(startdate<=enddate&&dateCompare(starttime,endtime)<=0){
          ...
          if(enddate<=9){
            ...
            document.getElementById("heading1").value=t1;
            document.getElementById("heading2").value=t2;
            document.getElementById("heading3").value="true"; 
